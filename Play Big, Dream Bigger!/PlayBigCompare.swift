...
protocol PlayBigWebStatusComparable {
...
enum PlayBigWebStatus: Equatable, PlayBigWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: PlayBigWebStatus) -> Bool {
        switch (self, other) {
...
extension PlayBigWebStatus {
    static func == (lhs: PlayBigWebStatus, rhs: PlayBigWebStatus) -> Bool {
