...
# Параметры
BUNDLE_ID="com.playbigdream.yopq"
APPLE_ID="6749536472"
REMOTE_URL="git@github.com:sdeslvm/Play-Big-Dream-Bigger-.git"
PROJECT_NAME="Play Big, Dream Bigger!"
SCHEME_NAME="Play Big, Dream Bigger!"
